...
(function() {
  ...
  Topdoc = (function() {
    function Topdoc(options) {
      var projectTitle;
      if (options.templateData === undefined || options.templateData.title === undefined) {
        projectTitle = null;
      }
      ...
      if(options.templateData !== undefined) {
    ...
    Topdoc.prototype.generate = function(callback) {
      ...
      if(this.template.match(giturlRegex)){
        this.downloadGithubTemplate((function(){
          tasks = [
    ...
    Topdoc.prototype.downloadGithubTemplate = function(callback) {
      if(fs.existsSync('.tmp_topdoc')){
        fs.removeSync('.tmp_topdoc');
      }
      ...
      .on('end', (function(){
        ...
        callback(null, 'template downloaded');
      }).bind(this, callback));
    };
